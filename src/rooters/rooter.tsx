...
import MantenimientoComponent from "@/pages/main/mantenimiento.tsx";
import NotFoundComponent from "@/pages/main/notfound.tsx";
...
export const router = createHashRouter([
    {
        ...
        children: [
            ...
            { path: 'ministerios', element: <MantenimientoComponent /> },
